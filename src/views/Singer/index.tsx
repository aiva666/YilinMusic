...
const Singer: FC = (props: any) => {
    ...
    const getSingerData = async () => {
        let res:any = await getSingerList();
        if (res) {
            setCardList(res.artists);
        }
    };
    ...
    }, [activeLanguage, activePersonClass, activeFilterWord]);
